...
from sql_execute import plants_tb_select,gender_number,dashboard_select,plan_year_options_select,\
farmer_lastname_select,columns_name_independent_weather,weight_year_by_vil,\
...
def main():
    ...
    #     with col1:
    #         st.markdown("##### ครอบครัวที่เป็นสมาชิกเกษตรกรในโครงการ")
    #         dt = farmer_lastname_select(farm_vil_selected[0])
    #         tup = tuple(tuple(sub) for sub in dt)
    #         # st.write(tup)
    #         data = [
    ...
    #     with col2:
    #         gender_number(farm_vil_selected[0])
main()